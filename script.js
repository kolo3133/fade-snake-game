window.addEventListener("DOMContentLoaded", function (event) {
  ...
  let speed = 150; // Milliseconds it takes for the snake to take a step in the grid
  ...
  let contrastIncrease = 0.5; // contrast you gain after each score
  ...
  function getNextPosition() {
    ...
    switch (snakeDirection) {
      case "right": {
        ...
        // Ignore the last snake part, it will move out as the head moves in
